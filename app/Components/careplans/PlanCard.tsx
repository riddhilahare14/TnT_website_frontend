...
export default function PlanCard({ plan }: PlanCardProps) {
  return (
    // CHANGE: Added 'border border-[#2F5F88]' to give every card a thin blue border
    <div className="bg-white rounded-3xl p-8 shadow-md hover:shadow-xl transition-shadow border border-[#2F5F88]">
      ...
      {/* Subscribe Button - Uniform Style */}
      {/* Default: Transparent with Blue Border/Text */}
